...
def cmap(input: [Series, list], palette: LinearSegmentedColormap | ListedColormap | str, log: bool = False, pydeck: bool = True, factorize: bool = False, var_range=None) -> list[int]:  # type: ignore
